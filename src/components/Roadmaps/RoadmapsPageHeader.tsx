...
export function RoadmapsPageHeader() {
  return (
    <div style={{ backgroundColor: '#66fcf1' }} className="py-3 sm:py-12">
      <div className="container">
      <div style={{ backgroundColor: '#66fcf1' }} className="flex flex-col items-start sm:items-center">
          <h1 className="text-2xl font-bold sm:text-5xl">List of Learning Content</h1>
          <p className="mb-3 mt-1 text-sm sm:my-3 sm:text-lg">
            Browse the list of up-to-date learning contents
          </p>
