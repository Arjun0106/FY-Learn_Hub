...
export function TopicProgressButton(props: TopicProgressButtonProps) {
  ...
  if (isUpdatingProgress) {
    return (
      <button className="inline-flex cursor-default items-center rounded-md border border-gray-300 bg-black p-1 px-2 text-sm text-black">
  ...
  return (
    <div className="relative inline-flex rounded-md border border-[#66fcf1]">
      <span className="inline-flex cursor-default items-center  p-1 px-2 text-sm text-[#66fcf1]">
      ...
      <button
        className="inline-flex cursor-pointer items-center rounded-br-md rounded-tr-md border-l border-[#66fcf1] bg-[#66fcf1] p-1 px-2 text-sm text-[#66fcf1] hover:bg-[#66fcf1]"
